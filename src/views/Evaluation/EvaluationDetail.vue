    ...
    <div v-else>
      <div class="banner-container" :class="addBGColor(aspect)">
        ...
        <div class="banner-desc">
          Aliqua velit ex quis amet ad officia minim ex magna culpa voluptate consequat culpa pariatur consequat
          deserunt
          aute laborum. Sit nostrud adipiscing aliqua qui laboris ex est adipiscing amet do incididunt laborum
          pariatur
          incididunt esse esse ipsum magna dolore.Aliqua velit ex quis amet ad officia minim ex magna culpa voluptate
          consequat culpa pariatur consequat deserunt aute laborum. 
        </div>
      </div>
      <div class="detail-container">
        <div class="pipline-title">
          <div class="pipline-desc">
            ...
            <div class="block"> Aliqua velit ex quis amet ad officia minim ex magna culpa voluptate consequat culpa pariatur
                consequat deserunt
                aute laborum.
            </div>
          </div>
        ...
        <div class="pipeline-container">this is pipeline</div>
